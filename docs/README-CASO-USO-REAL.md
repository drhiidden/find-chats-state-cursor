...
2. `docs/integracion-3d-mcp.md` - Guía de opciones MCP/CLI (local del proyecto)
3. `docs/QUICKSTART-3D.md` - Guía rápida
4. `docs/SETUP-BLENDER-CLI.md` - Setup del CLI

### Configuración

```json
// C:\Users\DevUser\.cursor\mcp.json
{
  "mcpServers": {
    "blender": {
      "command": "node",
      "args": ["C:\\Users\\DevUser\\Documents\\game-dev-workspace\\Sample Game Project\\scripts\\blender_mcp_server.js"]
    }
  }
}
```
...
**Proyecto:** Sample Game Project (Godot + Blender MCP)  
**Usuario:** @drhiidden  
